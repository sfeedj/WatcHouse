...
<head>
  ...
  <link rel="stylesheet" href="/../APPwebsite/Style/backLog.css">
</head>
...
<body>
  ...
  <div class="ConnectionPanel">
    ...
    <form action="/../APPwebsite/Controller/frontLogin.php" method="post" class="formulaire">
      ...
      <br/>
      <a href="#" class="popup"><span>Utilisez vos identifiants administrateur !</span><img src="/../APPwebsite/View/logoInterrogation.png" alt="" class="logoInterrogation"></a>
      <br/>
  ...
  <a href="/../APPwebsite/index.php?page=frontLogin" class="logoAdmin" title="Accès Utilisateur"><img src="/../APPwebsite/View/user.png" ></a>
  <div>    <br/>
    <div id="listePlus">
    <ul class="listePlus">
      <li>Confort</li>
