...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 07 mai 2018 à 08:36
...
('WatcHouse CeMac', 'Centrale', '50.00', 'Voici le coeur de notre système de Domotique. Ce système, entièrement équipé de capteurs, collecte les données de température, de luminosité, d\'humidité de votre pièce. ', '../images/CeMac.png', 1),
('WatcHouse Thermomètre', 'Module', '8.00', 'Cet outil permet des mesures précises de température. Relié au CeMac, vous pourrez ainsi contrôler la température de la pièce que vous souhaitez.', '../images/Thermometre.png', 2),
('WatcHouse Luxmètre', 'Capteur', '5.00', 'Détecteur de luminosité ; compatible avec les Smart Light Bulb, Smart Stores, ...', '../images/Luxmetre.png', 3),
('WatcHouse Smart Lightbulb', 'Actionneur', '10.00', 'Ampoule connectée.', '../images/Light.png', 4),
('WatcHouse Smart Outlet', 'Module', '20.00', 'Prise électrique connectée : surveillez votre consommation et gérez-la à distance !', '../images/Prise.png', 5),
('WatcHouse Oversight', 'Capteur', '80.00', 'Caméra de surveillance reliable à la CeMac.', '../images/Camera.png', 8),
('WatcHouse Hygromètre', 'Capteur', '15.00', 'Surveillez l\'humidité de vos pièces.', '../images/Hygrometre.png', 6),
('WatcHouse Motion Sensor', 'Capteur', '15.00', 'Réagit au mouvement.', '../images/Mouvement.png', 7),
('WatcHouse Sound System', 'Module', '100.00', 'Le nouveau système sonore sans fil.', '../images/Sound.png', 18);
...
(1, 'Chez Bobby', '', 1, '\"test\"', '2018-04-21 09:50:43'),
(2, 'Chez les parents', '', 1, '\"test\"', '2018-04-21 09:50:43'),
...
(3, 2, 1, '2018-05-05 10:21:36', 'test'),
...
(4, 'Eliott', 'password2', 'eliott.sfedj@hotmail.fr', 0, '2018-04-21 09:49:53'),
